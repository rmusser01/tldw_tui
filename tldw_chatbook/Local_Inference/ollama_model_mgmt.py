...
def ollama_list_local_models(base_url: str) -> Tuple[
    ...
    return _ollama_request("GET", base_url, "/api/tags")
...
def ollama_delete_model(base_url: str, model_name: str, stream_log_callback: Optional[Callable[[str], None]] = None,
    ...
    return _ollama_request("DELETE", base_url, "/api/delete", stream_log_callback=stream_log_callback, json={"name": model_name})
...
def ollama_pull_model(base_url: str, model_name: str, insecure: bool = False,
    ...
    return _ollama_request("POST", base_url, "/api/pull", stream_log_callback=stream_log_callback, json=payload)
...
def ollama_list_running_models(base_url: str) -> Tuple[
    ...
    return _ollama_request("GET", base_url, "/api/ps")