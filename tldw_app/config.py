...
# --- File Validation/YARA Settings (Loaded from Env or TOML later) ---
YARA_RULES_PATH: Optional[str] = None
MAGIC_FILE_PATH: Optional[str] = os.getenv("MAGIC_FILE_PATH", None)
...
def load_settings() -> Dict:
    ...
    config_dict = {
        ...
        # File Validation
        "YARA_RULES_PATH": _get_typed_value(file_validation_section, "yara_rules_path", YARA_RULES_PATH), # YARA_RULES_PATH is global default
        "MAGIC_FILE_PATH": _get_typed_value(file_validation_section, "magic_file_path", MAGIC_FILE_PATH), # MAGIC_FILE_PATH is global default
...
# Update global YARA_RULES_PATH and MAGIC_FILE_PATH from settings if they were set via TOML
YARA_RULES_PATH = settings.get("YARA_RULES_PATH", YARA_RULES_PATH)
MAGIC_FILE_PATH = settings.get("MAGIC_FILE_PATH", MAGIC_FILE_PATH)
